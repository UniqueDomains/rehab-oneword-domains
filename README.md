...
> **Important:** this repository is a **public 9,702-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,952 domains** on the canonical page below.

**Public extract:** 9,702 rows · **Live catalog:** 5,621,952 domains
...
- `rehab.csv` — public CSV extract (9,702 rows)
- `rehab.json` — public JSON extract (9,702 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,702-row public sample | 5,621,952 live domains                           |
...
> Unique Domains. *Available .REHAB One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
